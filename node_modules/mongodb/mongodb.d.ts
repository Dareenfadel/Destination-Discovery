...
export declare class MongoClient extends TypedEventEmitter<MongoClientEvents> {
    ...
    /** Callbacks are deprecated and will be removed in the next major version. See [mongodb-legacy](https://github.com/mongodb-js/nodejs-mongodb-legacy) for migration assistance */
